	...
	return (
		<div className='container p-4'>
			<div className='relative h-12'>
				...
				<button
					onClick={handleClick}
					className='absolute bottom-0 right-0 bg-[#2a8463] border-2 border-[#20cd8d] px-10 pe-6 h-full text-white text-lg rounded-full outline-none hover:bg-[#276e54] transition-colors'>
					Add
					<img
